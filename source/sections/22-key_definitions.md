...
* *Application*: An application hosted by Consensus Networks, either maintained and created by Consensus Networks, or maintained and created by a Customer or Partner on HealthNet.

* *Application Level*: Controls and security associated with an Application. In the case of HealthNet Customers, Consensus Networks does not have access to and cannot assure compliance with security standards and policies at the Application Level.
...
* *Backup Service*: A logging service for unifying system and application logs, encrypting them, and providing a dashboard for them. Offered with all HealthNet Customers.
...
* *Customers*: Contractually bound users of HealthNet Platform.
...
* *Event*: An event is defined as an occurrence that does not constitute a serious adverse effect on Consensus Networks, its operations, or its Customers, though it may be less than optimal. Examples of events include, but are not limited to:
...
* *Indication*: A sign that an Incident may have occurred or may be occurring at the present time. Examples of indications include:
  ...
  * Automated alerts of activity from log monitors like Snort;
  * An alert from Snort about file system integrity issues.
...
* *IDS Service*: An Intrusion Detection Service for providing IDS notification to customers in the case of suspicious activity. Offered with all HealthNetCustomers.
...
* *Logging Service*: A logging service for unifying system and application logs, encrypting them, and providing a dashboard for them. Offered with all HealthNet Customers.
...
* *Organization*: For the purposes of this policy, the term "organization" shall mean Consensus Networks.

* *Partner*: Contractual bound 3rd party vendor with integration with the Consensus Networks HealthNet Platform. May offer Add-on services.

* *Platform*: The overall technical environment of Consensus Networks HealthNet Platform.
...
* *Security Incident* (or just Incident): A security incident is an occurrence that exercises a significant adverse effect on people, process, technology, or data. Security incidents include, but are not limited to:
  ...
  * Unauthorized change or destruction of ePHI (i.e. delete dictation, data alterations not following Consensus Networks' procedures);
...
* *Vendors*: Persons from other organizations marketing or selling products or services, or providing services to Consensus Networks.
